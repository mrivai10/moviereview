...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2023 at 02:07 PM
...
--
ALTER TABLE `review`
  MODIFY `id_review` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `trailer`
--
ALTER TABLE `trailer`
  MODIFY `id_trailer` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
